				...
				<div class="container">
					...
					<div class="post">
						...
						<div class="body">
							...
							<img src="img/sample_image.png" alt="Sample Image" height="130" width="130" class="left" />
...
<!-- 
		<div class="right" id="main_right">
			...
			<div id="sidebar">
				...
				<div class="content">
					<a href="#" style="font-size: 10pt;">quis</a>
					<a href="#" style="font-size: 11pt;">montesa</a>
					<a href="#" style="font-size: 9pt;">nascetur</a>
					<a href="#" style="font-size: 9pt;">ridiculus</a>
					<a href="#" style="font-size: 8pt;">semper</a>
					<a href="#" style="font-size: 12pt;">clean</a>
					<a href="#" style="font-size: 8pt;">convallis</a>
					<a href="#" style="font-size: 14pt;">tempor</a>
					<a href="#" style="font-size: 8pt;">sociis</a>
					<a href="#" style="font-size: 9pt;">feugiat</a>
					<a href="#" style="font-size: 8pt;">quam</a>
					<a href="#" style="font-size: 10pt;">euismod</a>
					<a href="#" style="font-size: 9pt;">ligula</a>
					<a href="#" style="font-size: 10pt;">penatibus</a>
					<a href="#" style="font-size: 8pt;">aliquam</a>
					<a href="#" style="font-size: 8pt;">sapien</a>
					<a href="#" style="font-size: 8pt;">volutpat</a>
					<a href="#" style="font-size: 11pt;">natoque</a>
					<a href="#" style="font-size: 8pt;">tincidunt</a>
					<a href="#" style="font-size: 8pt;">varius</a>
					<a href="#" style="font-size: 8pt;">summer</a>
					<a href="#" style="font-size: 8pt;">pellentesque</a>
					<a href="#" style="font-size: 9pt;">curabitur</a>
					<a href="#" style="font-size: 8pt;">porta</a>
				</div>
